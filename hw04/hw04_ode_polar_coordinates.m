...
function hw_solution
  ...
  for n=0:1:5  % Initial condition range set from -10 to 10
    ...
    plot(t,x(:,1),'-ok','LineWidth',2,t,x(:,3),'-*k','LineWidth',2);
...
print -f1 img/fig01.png
print -f2 img/fig02.png
print -f3 img/fig03.png
print -f10 img/fig10.png
print -f11 img/fig11.png
print -f12 img/fig12.png
